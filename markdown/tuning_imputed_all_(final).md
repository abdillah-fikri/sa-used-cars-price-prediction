...
```python cell_id="00035-adb3a37b-199a-4d0e-ba89-ea8c10843673" execution={"iopub.execute_input": "2020-10-13T13:29:52.833962Z", "iopub.status.busy": "2020-10-13T13:29:52.833962Z", "iopub.status.idle": "2020-10-13T13:29:52.864878Z", "shell.execute_reply": "2020-10-13T13:29:52.863881Z", "shell.execute_reply.started": "2020-10-13T13:29:52.833962Z"} id="bKob_zWgIakl" output_cleared=false tags=[] outputId="cab68c39-a4f2-4aaf-8ecc-d438b5cfbf9b" colab={"base_uri": "https://localhost:8080/"}
import numpy as np
import pandas as pd
...
```python id="uOHFykGLHlTs" outputId="673b902e-d3d9-4956-ff8c-37a9a1c072c3" colab={"base_uri": "https://localhost:8080/", "height": 204}
df = pd.read_csv('after_prep.csv')
df.head()
```

```python id="Q7_R-5ZmHlTx" outputId="6c7d649a-4703-4977-d31b-6d3be82db63c" colab={"base_uri": "https://localhost:8080/"}
df.info()
```
...
```python id="w_QmQ1-COIRX" outputId="01369227-5f56-4712-f8e9-334e9808a0f1" colab={"base_uri": "https://localhost:8080/"}
# Target Encoding
...
```python id="qwWoTc--ImFJ" outputId="21c9bb49-0ae2-4d2e-98ec-4223db73e607" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
```python id="NsHKTHFSIm49" outputId="713fa8e7-5178-4374-8f54-34324ac8c379" colab={"base_uri": "https://localhost:8080/"}
...
```python id="yWR-ZmE3WxaI" outputId="cab31409-7b46-499e-9791-23fd2d47b12d" colab={"base_uri": "https://localhost:8080/"}
dtrain = xgb.DMatrix(X_train, label=y_train)
...
```python id="MzSy2WLUNqhN" outputId="42a4a3c2-66d5-4d43-8a91-1d56e880f1a4" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
```python id="ggqbIf3UNqYX" outputId="9a0e34d7-0f5d-484a-ab01-708626c3ab5e" colab={"base_uri": "https://localhost:8080/"}
...
```python id="C1CGZcryWz4x" outputId="0f677d82-5093-4743-8e96-29a54b4d6b72" colab={"base_uri": "https://localhost:8080/"}
dtrain = xgb.DMatrix(X_train, label=y_train)
dtest = xgb.DMatrix(X_test, label=y_test)
...
```python id="z3T7iSxoaUPA" outputId="829b8b9d-e0e5-40ff-a6e1-6dfb9e214deb" colab={"base_uri": "https://localhost:8080/", "height": 227}
...
```python id="a2gYuFxmYBF4" outputId="46f3d28a-393b-4680-df64-8418c6fe05e0" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
```python id="Dp9QnijQYBGD" outputId="368e32f8-c8b3-4a41-89bf-570de113fcd2" colab={"base_uri": "https://localhost:8080/"}
...
```python id="H03n4RSjYBGH" outputId="d895284b-b434-4358-f27b-d970b88f3243" colab={"base_uri": "https://localhost:8080/"}
dtrain = xgb.DMatrix(X_train, label=y_train)
dtest = xgb.DMatrix(X_test, label=y_test)
...
```python id="bQp80jXaYXuG" outputId="67a816fd-909c-4e24-e931-3c0ea696fd46" colab={"base_uri": "https://localhost:8080/", "height": 292}
xgb_study_1 = XGBRegressor(**xgb_param_1, n_estimators=xgb_n_estimators_1)
xgb_study_2 = XGBRegressor(**xgb_param_2, n_estimators=xgb_n_estimators_2)
...
```python id="_DBuAfcmMZgK" outputId="981ce043-a99c-4e29-9295-9c13a728de0a" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
```python id="w-RaxMEsMZgS" outputId="f869abbb-0939-4121-cc46-f7e62aa47881" colab={"base_uri": "https://localhost:8080/"}
# Get best params then add to param_1
...
```python id="kY2PHvvqMZgW" outputId="1d02486f-cc45-4228-e427-6aa904d16e13" colab={"base_uri": "https://localhost:8080/"}
dtrain = lgb.Dataset(X_train, label=y_train)
...
```python id="5ofs6sGjMZgb" outputId="b5de9e48-8a13-4150-ee0f-4265b20f3433" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
```python id="PEUnEOY2MZgf" outputId="c2e4860e-72a8-4c63-a0bf-4a90d4df7370" colab={"base_uri": "https://localhost:8080/"}
# Get best params then add to param_2
...
```python id="8i-_ufqKIX8O" outputId="84532adb-9e66-4954-920b-465807986d37" colab={"base_uri": "https://localhost:8080/"}
lgb_param_2['learning_rate'] = 0.01
lgb_param_2
```

```python id="31_EVr9BMZgi" outputId="df603c1b-0b7a-4a5d-a00e-012254fd3094" colab={"base_uri": "https://localhost:8080/"}
dtrain = lgb.Dataset(X_train, label=y_train)
...
```python id="L323nvX2MZgm" outputId="0a736a77-f7fd-48cb-cc28-4a6c6b60c7f8" colab={"base_uri": "https://localhost:8080/", "height": 227}
...
```python id="1yqpJRkqMZgr" outputId="f5484a17-095b-4d46-b369-865b1953c862" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
```python id="hRrJ92p_MZgu" outputId="d6bad2e0-fcb1-4fba-9145-a604bdb5cb87" colab={"base_uri": "https://localhost:8080/"}
# Get best params then add to param_3
...
```python id="kVNd4F6mMZgx" outputId="3aa1f765-3300-4688-b06c-b256823fa149" colab={"base_uri": "https://localhost:8080/"}
dtrain = lgb.Dataset(X_train, label=y_train)
...
```python id="Ita98N6JMZg1" outputId="7dd0be9e-f414-4450-f6ae-36152c2a2cb8" colab={"base_uri": "https://localhost:8080/", "height": 292}
lgb_study_1 = LGBMRegressor(**lgb_param_1, n_estimators=lgb_n_estimators_1)
lgb_study_2 = LGBMRegressor(**lgb_param_2, n_estimators=lgb_n_estimators_2)
