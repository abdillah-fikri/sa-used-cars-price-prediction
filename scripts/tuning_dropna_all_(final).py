...
# %% cell_id="00035-adb3a37b-199a-4d0e-ba89-ea8c10843673" execution={"iopub.execute_input": "2020-10-13T13:29:52.833962Z", "iopub.status.busy": "2020-10-13T13:29:52.833962Z", "iopub.status.idle": "2020-10-13T13:29:52.864878Z", "shell.execute_reply": "2020-10-13T13:29:52.863881Z", "shell.execute_reply.started": "2020-10-13T13:29:52.833962Z"} id="bKob_zWgIakl" output_cleared=false tags=[]
import numpy as np
import pandas as pd
...
# %% colab={"base_uri": "https://localhost:8080/"} id="w_QmQ1-COIRX" outputId="0ee7122f-0a35-40c6-f090-ff3f3299f93d"
# Target Encoding
...
# %% colab={"base_uri": "https://localhost:8080/"} id="qwWoTc--ImFJ" outputId="0168a8dd-bae2-4667-cd01-bb7240c2de29"
def objective(trial):
...
# %% colab={"base_uri": "https://localhost:8080/"} id="NsHKTHFSIm49" outputId="c7d81757-2cd5-4003-cc37-b646888062dc"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="yWR-ZmE3WxaI" outputId="b4414985-f66e-4981-9794-178d428e76db"
dtrain = xgb.DMatrix(X_train, label=y_train)
...
# %% colab={"base_uri": "https://localhost:8080/"} id="MzSy2WLUNqhN" outputId="57cda43d-1fe8-4993-d026-4fbe58a362d3"
def objective(trial):
...
# %% colab={"base_uri": "https://localhost:8080/"} id="ggqbIf3UNqYX" outputId="6b78f3c2-cc06-4a49-f692-5dd7293349d7"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="C1CGZcryWz4x" outputId="cf5d1998-4da7-47b7-b6f2-5ea9e9cdb1cf"
dtrain = xgb.DMatrix(X_train, label=y_train)
dtest = xgb.DMatrix(X_test, label=y_test)
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 227} id="z3T7iSxoaUPA" outputId="79292a28-61a3-4dea-dc41-3d3669808a63"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="a2gYuFxmYBF4" outputId="e310ec21-be00-4594-a9f0-9c51ba82d344"
def objective(trial):
...
# %% colab={"base_uri": "https://localhost:8080/"} id="Dp9QnijQYBGD" outputId="e553402e-6912-4c46-a080-b410424cb618"
# Get best params then add to param_3
xgb_param_3 = xgb_param_2.copy()
xgb_param_3["learning_rate"] = study.best_params["learning_rate"]
xgb_param_3

# %% colab={"base_uri": "https://localhost:8080/"} id="H03n4RSjYBGH" outputId="284e21be-b77b-487d-a75e-bf49cc5062ac"
dtrain = xgb.DMatrix(X_train, label=y_train)
dtest = xgb.DMatrix(X_test, label=y_test)
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 292} id="bQp80jXaYXuG" outputId="dd042fe9-a67c-431e-8425-2e4398570efe"
xgb_study_1 = XGBRegressor(**xgb_param_1, n_estimators=xgb_n_estimators_1)
xgb_study_2 = XGBRegressor(**xgb_param_2, n_estimators=xgb_n_estimators_2)
...
# %% colab={"base_uri": "https://localhost:8080/"} id="_DBuAfcmMZgK" outputId="a9fd70cf-3394-42a1-9c6c-0fda3bc1dd74"
def objective(trial):
...
# %% colab={"base_uri": "https://localhost:8080/"} id="w-RaxMEsMZgS" outputId="134d57dd-f374-4ce0-e447-3f00bf782fea"
# Get best params then add to param_1
...
# %% colab={"base_uri": "https://localhost:8080/"} id="kY2PHvvqMZgW" outputId="84b6e34a-520a-4bc9-86d3-b7b62c4006e5"
dtrain = lgb.Dataset(X_train, label=y_train)
...
# %% colab={"base_uri": "https://localhost:8080/"} id="5ofs6sGjMZgb" outputId="7998c696-16dc-49a4-a9ad-27f5a9367112"
def objective(trial):
...
# %% colab={"base_uri": "https://localhost:8080/"} id="PEUnEOY2MZgf" outputId="ebf8ba52-a67e-465e-af85-2061aa5c88d4"
# Get best params then add to param_2
...
# %% colab={"base_uri": "https://localhost:8080/"} id="8i-_ufqKIX8O" outputId="45fdfe66-4ef8-4e6d-b5cc-8a7b10f26403"
lgb_param_2['learning_rate'] = 0.01
lgb_param_2

# %% colab={"base_uri": "https://localhost:8080/"} id="31_EVr9BMZgi" outputId="5128c77f-5ed6-44de-dbc1-08bec21671f2"
dtrain = lgb.Dataset(X_train, label=y_train)
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 227} id="L323nvX2MZgm" outputId="06ddabf3-0204-49e5-c4b7-4fa67204d049"
...
# %% colab={"base_uri": "https://localhost:8080/"} id="1yqpJRkqMZgr" outputId="56ae2288-5844-4198-c39f-74f6f35c4db3"
def objective(trial):
...
# %% colab={"base_uri": "https://localhost:8080/"} id="hRrJ92p_MZgu" outputId="a4c9d402-3207-455e-b97a-a3cc144c127d"
# Get best params then add to param_3
lgb_param_3 = lgb_param_2.copy()
lgb_param_3["learning_rate"] = study.best_params["learning_rate"]
lgb_param_3

# %% colab={"base_uri": "https://localhost:8080/"} id="kVNd4F6mMZgx" outputId="ef155009-c4a9-4ba6-84e6-a0e5dea1a0c7"
dtrain = lgb.Dataset(X_train, label=y_train)
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 292} id="Ita98N6JMZg1" outputId="375f702a-84bf-4add-8545-69126b4dd3ce"
lgb_study_1 = LGBMRegressor(**lgb_param_1, n_estimators=lgb_n_estimators_1)
lgb_study_2 = LGBMRegressor(**lgb_param_2, n_estimators=lgb_n_estimators_2)
