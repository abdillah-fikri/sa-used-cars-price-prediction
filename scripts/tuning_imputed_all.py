...
# %% id="kqlZgC2QIUa_" outputId="e8398ccf-4876-4da6-9b79-dacd33e1d5f6" colab={"base_uri": "https://localhost:8080/", "height": 1000}
pip install -r requirements.txt

# %% [markdown] id="Y0sQL3fRHlWV"
# # Data Importing

# %% id="HGU4TdhJHlWW" outputId="e2520e58-b5bd-4c3f-cd92-093651b7e452" colab={"base_uri": "https://localhost:8080/"}
import pandas as pd
import numpy as np
...
# %% id="PLDflXqmHlWb" outputId="66d30453-246e-4392-deb7-6001ad1424cd" colab={"base_uri": "https://localhost:8080/", "height": 204}
df = pd.read_csv('after_prep.csv')
df.head()

# %% id="7yBxceHkHlWf" outputId="76b1ec78-3398-4c73-a0c9-7d5e945244b5" colab={"base_uri": "https://localhost:8080/"}
df.info()

# %% [markdown] id="g1GS1AAUZIt9"
# # Preprocessing

# %% execution={"iopub.execute_input": "2020-10-15T12:50:17.869621Z", "iopub.status.busy": "2020-10-15T12:50:17.869621Z", "iopub.status.idle": "2020-10-15T12:50:17.883583Z", "shell.execute_reply": "2020-10-15T12:50:17.882586Z", "shell.execute_reply.started": "2020-10-15T12:50:17.869621Z"} id="INV8VvOYZItN" outputId="3a63edac-8314-4e12-bb2e-6d05b83a85e9" colab={"base_uri": "https://localhost:8080/"}
# Delete outlier
...
# %% id="SvdzWhppONbl" outputId="1c9a5f8c-f338-43a0-adbf-dab27b161c05" colab={"base_uri": "https://localhost:8080/", "height": 241}
...
# %% execution={"iopub.execute_input": "2020-10-15T12:50:17.884579Z", "iopub.status.busy": "2020-10-15T12:50:17.884579Z", "iopub.status.idle": "2020-10-15T12:50:17.898543Z", "shell.execute_reply": "2020-10-15T12:50:17.897546Z", "shell.execute_reply.started": "2020-10-15T12:50:17.884579Z"} id="nPxFt6bSZIt-"
...
# %% id="EfuIKvdGpL0B" outputId="330a95d5-fe4a-4340-838b-c98539b0009e" colab={"base_uri": "https://localhost:8080/"}
# One hot encoding
...
# %% execution={"iopub.execute_input": "2020-10-15T12:50:18.102994Z", "iopub.status.busy": "2020-10-15T12:50:18.101997Z", "iopub.status.idle": "2020-10-15T12:50:18.179789Z", "shell.execute_reply": "2020-10-15T12:50:18.178825Z", "shell.execute_reply.started": "2020-10-15T12:50:18.102994Z"} id="kcMLnvJxZIuD" outputId="e265bb11-4ada-4276-afbf-831dd3ea89d2" colab={"base_uri": "https://localhost:8080/"}
# Target encoding
...
# %% id="1V7znCDAVRXl" outputId="4f634202-ad44-4606-c9f5-d90c41869243" colab={"base_uri": "https://localhost:8080/", "height": 241}
X_train_full.head()
...
# #### Study 1
 ...
 # %% id="qwWoTc--ImFJ" outputId="4dc410d4-da23-4a1d-d3ee-d09df8633c24" colab={"base_uri": "https://localhost:8080/"}
 def objective(trial):
...
# %% id="NsHKTHFSIm49" outputId="e7f61f7b-c6e3-4db5-c6fa-45bfb3439dae" colab={"base_uri": "https://localhost:8080/"}
...
# %% id="yWR-ZmE3WxaI" outputId="566fe29a-7309-451f-8d82-1ec863e5299d" colab={"base_uri": "https://localhost:8080/"}
dtrain = xgb.DMatrix(X_train_full, label=y_train)
...
# %% id="MzSy2WLUNqhN" outputId="d4d8cc07-afbe-4db4-d750-8fcb1e893a8c" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
# %% id="ggqbIf3UNqYX" outputId="6c92f0c4-fe72-494f-e1d9-2ca7e137c58a" colab={"base_uri": "https://localhost:8080/"}
...
# %% id="C1CGZcryWz4x" outputId="ca88de46-9c54-4f17-c1bf-1e287e17e69e" colab={"base_uri": "https://localhost:8080/"}
dtrain = xgb.DMatrix(X_train_full, label=y_train)
...
# %% id="OLFchLJDXSSE" outputId="03276147-a466-4fce-a76f-bea368138742" colab={"base_uri": "https://localhost:8080/", "height": 111}
...
# %% id="_DBuAfcmMZgK" outputId="c9919557-8e91-4d8b-c1fb-9a0fb468a85d" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
# %% id="w-RaxMEsMZgS" outputId="64119a36-e56a-4e68-d3bc-1eb494228fee" colab={"base_uri": "https://localhost:8080/"}
# Get best params then add to param_1
study_1_params = study.best_params
param_1 = {
    "objective": "regression",
...
# %% id="kY2PHvvqMZgW" outputId="aed2d556-8c36-4677-8728-3c5e5f9765ca" colab={"base_uri": "https://localhost:8080/"}
dtrain = lgb.Dataset(X_train_full, label=y_train)
...
# %% id="5ofs6sGjMZgb" outputId="a6777166-49ad-4074-8356-26bf13947d75" colab={"base_uri": "https://localhost:8080/"}
def objective(trial):
...
# %% id="PEUnEOY2MZgf" outputId="2b1374b9-2175-4a17-dad4-477fa1ff3c77" colab={"base_uri": "https://localhost:8080/"}
# Get best params then add to param_2
study_2_params = study.best_params
param_2 = {
    "objective": "regression",
...
# %% id="31_EVr9BMZgi" outputId="20238999-c01e-40f7-c0e7-596b748b73a6" colab={"base_uri": "https://localhost:8080/"}
dtrain = lgb.Dataset(X_train_full, label=y_train)
...
# %% id="L323nvX2MZgm" outputId="8e1f1d2b-2124-4037-b0be-9c1ebadc5b9d" colab={"base_uri": "https://localhost:8080/", "height": 111}
...
# %% id="1yqpJRkqMZgr" outputId="003e7b8c-0df8-4569-abb2-f6f961e07203" colab={"base_uri": "https://localhost:8080/", "height": 510}
def objective(trial):
