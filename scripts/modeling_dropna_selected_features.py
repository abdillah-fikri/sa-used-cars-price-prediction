...
# %% execution={"iopub.execute_input": "2020-10-08T14:24:16.108907Z", "iopub.status.busy": "2020-10-08T14:24:16.107910Z", "iopub.status.idle": "2020-10-08T14:24:21.655591Z", "shell.execute_reply": "2020-10-08T14:24:21.651602Z", "shell.execute_reply.started": "2020-10-08T14:24:16.108907Z"} id="vBMQYoVFZIqV"
import pandas as pd
import numpy as np
...
# %% execution={"iopub.execute_input": "2020-10-08T14:24:21.657585Z", "iopub.status.busy": "2020-10-08T14:24:21.657585Z", "iopub.status.idle": "2020-10-08T14:24:21.670553Z", "shell.execute_reply": "2020-10-08T14:24:21.666562Z", "shell.execute_reply.started": "2020-10-08T14:24:21.657585Z"} id="aIt9SQtmZIqZ"
sns.set(style='darkgrid', palette='muted')

# %% cell_id="00002-1c7c9ecf-589f-4f15-9590-18a0d588c854" execution={"iopub.execute_input": "2020-10-08T14:24:21.677533Z", "iopub.status.busy": "2020-10-08T14:24:21.676535Z", "iopub.status.idle": "2020-10-08T14:24:21.746352Z", "shell.execute_reply": "2020-10-08T14:24:21.745353Z", "shell.execute_reply.started": "2020-10-08T14:24:21.677533Z"} id="S6ldr9t_Imtd" output_cleared=false
...
# %% cell_id="00004-051bff9d-c702-4146-a192-9dc23cb206dd" colab={"base_uri": "https://localhost:8080/", "height": 34} execution={"iopub.execute_input": "2020-10-08T14:24:21.815166Z", "iopub.status.busy": "2020-10-08T14:24:21.814169Z", "iopub.status.idle": "2020-10-08T14:24:21.842092Z", "shell.execute_reply": "2020-10-08T14:24:21.839103Z", "shell.execute_reply.started": "2020-10-08T14:24:21.815166Z"} executionInfo={"elapsed": 38905, "status": "ok", "timestamp": 1602465368030, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="t9SkWlvWIaiv" outputId="ead32c06-4246-4ef6-c361-9ef1d6cd9b08" output_cleared=false tags=[]
df.shape

# %% cell_id="00005-214f7a33-5f2d-48cc-86a1-c41cd663c527" colab={"base_uri": "https://localhost:8080/", "height": 111} execution={"iopub.execute_input": "2020-10-08T14:24:21.845085Z", "iopub.status.busy": "2020-10-08T14:24:21.844088Z", "iopub.status.idle": "2020-10-08T14:24:21.905922Z", "shell.execute_reply": "2020-10-08T14:24:21.902933Z", "shell.execute_reply.started": "2020-10-08T14:24:21.845085Z"} executionInfo={"elapsed": 38872, "status": "ok", "timestamp": 1602465368031, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="8lVpvltpIai0" outputId="2b09a4e3-520c-4d31-a674-58d5dbc6704d" output_cleared=false tags=[]
df[df['Mileage'].isna()]
...
# %% cell_id="00010-dd494b3f-977c-45a6-9a61-a44468a913b0" execution={"iopub.execute_input": "2020-10-08T14:24:22.010642Z", "iopub.status.busy": "2020-10-08T14:24:22.009645Z", "iopub.status.idle": "2020-10-08T14:24:22.063500Z", "shell.execute_reply": "2020-10-08T14:24:22.062503Z", "shell.execute_reply.started": "2020-10-08T14:24:22.010642Z"} id="s_ceUlxOKg7V" output_cleared=false
df['Brand'] = df['Name'].apply(lambda x: x.split(' ')[0])
df['Series'] = df['Name'].apply(lambda x: x.split(' ')[1])
df['Type'] = df['Name'].apply(lambda x: x.split(' ')[2])
df.drop(columns='Name', inplace=True)

# %% cell_id="00011-a1625de7-7e59-420d-844b-5a3a2d1e652d" colab={"base_uri": "https://localhost:8080/", "height": 204} execution={"iopub.execute_input": "2020-10-08T14:24:22.068490Z", "iopub.status.busy": "2020-10-08T14:24:22.067490Z", "iopub.status.idle": "2020-10-08T14:24:22.125335Z", "shell.execute_reply": "2020-10-08T14:24:22.124337Z", "shell.execute_reply.started": "2020-10-08T14:24:22.068490Z"} executionInfo={"elapsed": 38799, "status": "ok", "timestamp": 1602465368036, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="aY7bafplKu4K" outputId="88c26a14-3bcf-401e-c938-ed8e15072985" output_cleared=false
df.head()
...
# %% cell_id="00013-4aa8d13b-6dab-4f52-ae70-fc8f25367feb" colab={"base_uri": "https://localhost:8080/", "height": 68} execution={"iopub.execute_input": "2020-10-08T14:24:22.158246Z", "iopub.status.busy": "2020-10-08T14:24:22.158246Z", "iopub.status.idle": "2020-10-08T14:24:22.205122Z", "shell.execute_reply": "2020-10-08T14:24:22.202138Z", "shell.execute_reply.started": "2020-10-08T14:24:22.158246Z"} executionInfo={"elapsed": 39378, "status": "ok", "timestamp": 1602465368666, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="6m3Suen4Z_9Y" outputId="cb8c35be-1670-4514-dfe0-06208b33bf7a" output_cleared=false tags=[]
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 68} execution={"iopub.execute_input": "2020-10-08T14:24:22.207117Z", "iopub.status.busy": "2020-10-08T14:24:22.207117Z", "iopub.status.idle": "2020-10-08T14:24:22.251001Z", "shell.execute_reply": "2020-10-08T14:24:22.250002Z", "shell.execute_reply.started": "2020-10-08T14:24:22.207117Z"} executionInfo={"elapsed": 39354, "status": "ok", "timestamp": 1602465368667, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="IPkNA-lwZIrE" outputId="7c3ef55c-9a62-4353-f7a7-75ab785a6a63" tags=[]
...
# %% cell_id="00014-3095d6e2-739a-4e9a-91dd-1b6a1aeecb0c" colab={"base_uri": "https://localhost:8080/", "height": 68} execution={"iopub.execute_input": "2020-10-08T14:24:22.253991Z", "iopub.status.busy": "2020-10-08T14:24:22.252994Z", "iopub.status.idle": "2020-10-08T14:24:22.282914Z", "shell.execute_reply": "2020-10-08T14:24:22.281917Z", "shell.execute_reply.started": "2020-10-08T14:24:22.253991Z"} executionInfo={"elapsed": 39337, "status": "ok", "timestamp": 1602465368669, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="fvUS80s_t_k8" outputId="c19af63e-f409-47c8-bdf5-3c0fd99985c1" output_cleared=false
df['Mileage'].apply(lambda x: x if pd.isna(x) else x.split(' ')[1]).value_counts()

# %% cell_id="00016-3c631710-d459-4dc7-854c-9b601a8f78a7" execution={"iopub.execute_input": "2020-10-08T14:24:22.285906Z", "iopub.status.busy": "2020-10-08T14:24:22.284910Z", "iopub.status.idle": "2020-10-08T14:24:22.374668Z", "shell.execute_reply": "2020-10-08T14:24:22.372673Z", "shell.execute_reply.started": "2020-10-08T14:24:22.285906Z"} id="3kGt8wrVLscx" output_cleared=false
...
# %% cell_id="00019-2ad88c07-d7d0-4fb4-a7b0-94c417269d0a" colab={"base_uri": "https://localhost:8080/", "height": 419} execution={"iopub.execute_input": "2020-10-08T14:24:22.498338Z", "iopub.status.busy": "2020-10-08T14:24:22.497340Z", "iopub.status.idle": "2020-10-08T14:24:22.575132Z", "shell.execute_reply": "2020-10-08T14:24:22.574136Z", "shell.execute_reply.started": "2020-10-08T14:24:22.498338Z"} executionInfo={"elapsed": 39254, "status": "ok", "timestamp": 1602465368673, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="PJFktTnEIajw" outputId="f3cb791d-28ec-4998-e832-94efcf712ad0" output_cleared=false tags=[]
df[df['Mileage (kmpl)']==0]

# %% cell_id="00020-e43329af-54de-4465-87d6-cb3c4c39a087" colab={"base_uri": "https://localhost:8080/", "height": 80} execution={"iopub.execute_input": "2020-10-08T14:24:22.578125Z", "iopub.status.busy": "2020-10-08T14:24:22.577127Z", "iopub.status.idle": "2020-10-08T14:24:22.623004Z", "shell.execute_reply": "2020-10-08T14:24:22.622008Z", "shell.execute_reply.started": "2020-10-08T14:24:22.578125Z"} executionInfo={"elapsed": 39232, "status": "ok", "timestamp": 1602465368674, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="u6RCnI2OIajz" outputId="8278aefe-b8f7-421c-a5f6-e86443a54bd8" output_cleared=false tags=[]
df[df['Seats']==0]

# %% cell_id="00021-e0395a10-0bb0-43fd-99ef-52126dbb0aa8" execution={"iopub.execute_input": "2020-10-08T14:24:22.625996Z", "iopub.status.busy": "2020-10-08T14:24:22.624999Z", "iopub.status.idle": "2020-10-08T14:24:22.654919Z", "shell.execute_reply": "2020-10-08T14:24:22.653921Z", "shell.execute_reply.started": "2020-10-08T14:24:22.625996Z"} id="Afk7mbdfIaj2" output_cleared=false tags=[]
df['Mileage (kmpl)'] = df['Mileage (kmpl)'].replace(0, np.nan)
df['Seats'] = df['Seats'].replace(0, np.nan)

# %% cell_id="00022-bab6e9eb-e370-437d-bee9-837a51ebbb43" colab={"base_uri": "https://localhost:8080/", "height": 153} execution={"iopub.execute_input": "2020-10-08T14:24:22.657911Z", "iopub.status.busy": "2020-10-08T14:24:22.656913Z", "iopub.status.idle": "2020-10-08T14:24:22.702803Z", "shell.execute_reply": "2020-10-08T14:24:22.699800Z", "shell.execute_reply.started": "2020-10-08T14:24:22.657911Z"} executionInfo={"elapsed": 39201, "status": "ok", "timestamp": 1602465368677, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="wmm-4vqkIaj5" outputId="fe5583c0-17f9-406f-85cf-4bb6cd743485" output_cleared=false tags=[]
cat_cols = [col for col in df.columns if df[col].dtypes == 'object']
df[cat_cols].nunique()

# %% colab={"base_uri": "https://localhost:8080/", "height": 34} execution={"iopub.execute_input": "2020-10-08T14:24:22.705783Z", "iopub.status.busy": "2020-10-08T14:24:22.704786Z", "iopub.status.idle": "2020-10-08T14:24:22.717752Z", "shell.execute_reply": "2020-10-08T14:24:22.715757Z", "shell.execute_reply.started": "2020-10-08T14:24:22.705783Z"} executionInfo={"elapsed": 39177, "status": "ok", "timestamp": 1602465368678, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="Q2UrO_LJZIri" outputId="446f883d-cf38-4ce8-9d01-dfe94a438bed"
['a', 'b']

# %% cell_id="00023-826cb95b-08be-4095-8a0b-489a9f2a0fcc" colab={"base_uri": "https://localhost:8080/", "height": 1000} execution={"iopub.execute_input": "2020-10-08T14:24:22.721740Z", "iopub.status.busy": "2020-10-08T14:24:22.720743Z", "iopub.status.idle": "2020-10-08T14:24:22.748669Z", "shell.execute_reply": "2020-10-08T14:24:22.747671Z", "shell.execute_reply.started": "2020-10-08T14:24:22.721740Z"} executionInfo={"elapsed": 39156, "status": "ok", "timestamp": 1602465368679, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="YLT0EpfVlHZ2" outputId="ac81cd76-b286-4692-ac99-511ffec61664" output_cleared=false tags=[]
for col in cat_cols:
...
# %% cell_id="00025-57eb8332-9868-4559-adc8-cbaa48039fcd" colab={"base_uri": "https://localhost:8080/", "height": 85} execution={"iopub.execute_input": "2020-10-08T14:24:22.768623Z", "iopub.status.busy": "2020-10-08T14:24:22.767618Z", "iopub.status.idle": "2020-10-08T14:24:22.779586Z", "shell.execute_reply": "2020-10-08T14:24:22.778589Z", "shell.execute_reply.started": "2020-10-08T14:24:22.768623Z"} executionInfo={"elapsed": 39130, "status": "ok", "timestamp": 1602465368680, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="OXBlXSF3mZ4J" outputId="f5b8aa8a-57b6-4072-c3bc-b952d2ab1472" output_cleared=false tags=[]
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 483} execution={"iopub.execute_input": "2020-10-08T14:24:23.081170Z", "iopub.status.busy": "2020-10-08T14:24:23.080170Z", "iopub.status.idle": "2020-10-08T14:24:23.110089Z", "shell.execute_reply": "2020-10-08T14:24:23.109091Z", "shell.execute_reply.started": "2020-10-08T14:24:23.081170Z"} executionInfo={"elapsed": 39316, "status": "ok", "timestamp": 1602465369040, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="PMAtruMZZIsX" outputId="e8bb2232-a85e-4bbe-943c-d0840fa382da"
explor.null_checker(df)

# %% cell_id="00034-a74bd3e4-e566-4425-a0a5-cc1c9af4f640" execution={"iopub.execute_input": "2020-10-08T14:24:23.112084Z", "iopub.status.busy": "2020-10-08T14:24:23.112084Z", "iopub.status.idle": "2020-10-08T14:24:23.125050Z", "shell.execute_reply": "2020-10-08T14:24:23.124051Z", "shell.execute_reply.started": "2020-10-08T14:24:23.112084Z"} id="LbW9gLQVIakg" output_cleared=false tags=[]
df.loc[df['Fuel_Type']=='Electric', 'Mileage (kmpl)'] = df.loc[df['Fuel_Type']=='Electric', 'Mileage (kmpl)'].replace(np.nan, 0)

# %% cell_id="00035-adb3a37b-199a-4d0e-ba89-ea8c10843673" colab={"base_uri": "https://localhost:8080/", "height": 111} execution={"iopub.execute_input": "2020-10-08T14:24:23.127043Z", "iopub.status.busy": "2020-10-08T14:24:23.126046Z", "iopub.status.idle": "2020-10-08T14:24:23.155969Z", "shell.execute_reply": "2020-10-08T14:24:23.153972Z", "shell.execute_reply.started": "2020-10-08T14:24:23.127043Z"} executionInfo={"elapsed": 39278, "status": "ok", "timestamp": 1602465369042, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="bKob_zWgIakl" outputId="a60a5341-5df5-4af0-c4c1-e21a44d90fc2" output_cleared=false tags=[]
...
# %% execution={"iopub.execute_input": "2020-10-08T14:26:01.181734Z", "iopub.status.busy": "2020-10-08T14:26:01.181734Z", "iopub.status.idle": "2020-10-08T14:26:01.202651Z", "shell.execute_reply": "2020-10-08T14:26:01.201684Z", "shell.execute_reply.started": "2020-10-08T14:26:01.181734Z"} id="Qp4QHIuFZIuq"
...
# %% execution={"iopub.execute_input": "2020-10-08T14:26:01.236560Z", "iopub.status.busy": "2020-10-08T14:26:01.235563Z", "iopub.status.idle": "2020-10-08T14:26:01.249526Z", "shell.execute_reply": "2020-10-08T14:26:01.248529Z", "shell.execute_reply.started": "2020-10-08T14:26:01.236560Z"} id="BXEr8F5VZIu0"
...
# %% execution={"iopub.execute_input": "2020-10-08T15:10:17.976797Z", "iopub.status.busy": "2020-10-08T15:10:17.975799Z", "iopub.status.idle": "2020-10-08T15:10:17.988765Z", "shell.execute_reply": "2020-10-08T15:10:17.987767Z", "shell.execute_reply.started": "2020-10-08T15:10:17.976797Z"} id="Oux2OxeDZIu2"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 297} executionInfo={"elapsed": 38364, "status": "ok", "timestamp": 1602353945658, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="DgfsmUm-HqGG" outputId="890d1059-fe50-4ed7-87d9-16413c775534"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 297} executionInfo={"elapsed": 81010, "status": "ok", "timestamp": 1602353988430, "user": {"displayName": "Abdillah Fikri", "photoUrl": "", "userId": "04470220666512949031"}, "user_tz": -420} id="58C87fQHNRII" outputId="90af7df3-a745-4722-d77d-53f144212a91"
# evaluasi model memakai function
