...
# %% cell_id="00000-22bc0b26-1ea9-4900-a08a-fed218efdabd" output_cleared=false source_hash="9c12a302" execution_millis=554 execution_start=1602829891550
import pandas as pd
import numpy as np
...
# %% cell_id="00001-c84496a8-764a-4ebf-9d38-ea2d6e9b0438" output_cleared=false source_hash="93fbbcfd" execution_millis=117 execution_start=1602829939970
df_all_ver = pd.read_excel('Model_Summary.xlsx')

# %% cell_id="00002-fda41ab5-1578-4759-95fd-34bbab934939" output_cleared=false source_hash="a46fdaaf" execution_millis=82 execution_start=1602829944018
df_all_ver['Dataset Version'].unique()

# %% tags=[] cell_id="00003-7d415f67-fe9a-4bb4-9bee-fa5d53ac3de1" output_cleared=false source_hash="69479740" execution_millis=115 execution_start=1602852201510
...
# %% tags=[] cell_id="00003-5f4ebd9b-cf80-4066-b959-a02203215676" output_cleared=false source_hash="1be6e537" execution_millis=303 execution_start=1602851013982
...
# %% tags=[] cell_id="00004-e6cc76da-a309-4a59-8136-ad80d3a1ba4d" output_cleared=false source_hash="19d3c8" execution_millis=139 execution_start=1602851042958
fig = px.bar(
...
# %% cell_id="00003-0a221708-2f30-45f5-8507-8b3104cce91e" output_cleared=false source_hash="d1533531" execution_millis=211 execution_start=1602850857283
